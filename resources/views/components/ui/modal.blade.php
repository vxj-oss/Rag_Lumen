...
>
    ...
    <div
        ...
        class="w-full {{ $maxWidth }} max-h-[calc(100vh-2rem)] bg-white rounded-2xl overflow-hidden shadow-2xl ring-1 ring-black/5 transform transition-all flex flex-col"
        x-transition:enter="ease-out duration-300"
